...
export default function Testimonials() {
  return (
	  <div>
		<h1 className='text-gray-700 text-4xl uppercase font-bold text-center py-8 font-serif'>Testimonials</h1>
      <div class="bg-fixed object-cover h-full lg:h-[500px]  bg-cover " style={{"background-image": "url(https://www.icicidirect.com/images//TaxPlanning3-202304201525486813415.jpg"}}>
       <Carousel
      autoPlay
      infiniteLoop
      showStatus={false}
      ...
      showThumbs={false}
      interval={3000}
      className=' w-full lg:w-[1000px] mx-auto block rounded-full'
    >
      <div>
      <section className="my-8">
	<div className="container mx-auto  items-center pb-6 mb-4 md:p-10 md:px-12">
	...
	<div className="container mx-auto  gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
		<div className="flex flex-col items-center mx-12 lg:mx-0">
			<div className="relative text-center">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="absolute top-0 left-0 w-8 h-8 text-blue-700 ">
					<path d="M232,246.857V16H16V416H54.4ZM48,48H200V233.143L48,377.905Z"></path>
					<path d="M280,416h38.4L496,246.857V16H280ZM312,48H464V233.143L312,377.905Z"></path>
				</svg>
				<p className="px-6 py-1 md:text-lg text:sm italic">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus quibusdam, eligendi exercitationem molestias possimus facere.</p>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="absolute bottom-0 right-0 w-8 h-8 text-blue-700">
